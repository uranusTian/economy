...
public final class StatusBarUtils {
     ...
     * 复制当前Activity的状态栏主题
     */
    public static void setBarStateByActivity(Window mDialogWindow) {
        //如果导航栏不可见，Dialog弹出时也设置为不可见
        if(!isStatusBarVisible(ActivityLifecycleCallback.getInstance().getCurrentActivity())){
            setStatusBarVisibility(mDialogWindow,false);
        }
    }
