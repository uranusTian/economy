...
/**
 * An OkHttp interceptor which logs startRequest and response information. Can be applied as an
...
public final class LoggingInterceptor implements Interceptor {
    ...
    public enum Level {
        ...
        NONE,
        /**
         * Logs startRequest and response lines.
         *
         * <p>Example:
         * <pre>{@code
        ...
        BASIC,
        /**
         * Logs startRequest and response lines and their respective headers.
         *
         * <p>Example:
         * <pre>{@code
        ...
        HEADERS,
        /**
         * Logs startRequest and response lines and their respective headers and bodies (if present).
         *
         * <p>Example:
         * <pre>{@code
         * --> POST /greeting http/1.1
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            ...
            for (int i = 0, count = headers.size(); i < count; i++) {
                ...
                // Skip headers from the startRequest body as they are explicitly logged above.
